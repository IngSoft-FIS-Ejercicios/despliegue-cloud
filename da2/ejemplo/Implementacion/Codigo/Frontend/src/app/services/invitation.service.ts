...
export class InvitationService {
  ...
  createInvitation(invitation: InvitationRequest): Observable<Invitation> {
    return this.http
      .post<Invitation>(this.url, invitation, {
  ...
  getFilterInvitations(
    ...
    return this.http
      .get<Invitation[]>(this.url + filter, { headers: this.getHttpHeaders() })
      .pipe(
        tap(),
        catchError(
          this.handleError<Invitation[]>('Get Filtered Invitations', []),
        ),
      );
  }
  ...
  getNewUserCode(): Observable<Invitation> {
    ...
    return this.http
      .get<Invitation>(url, { headers: this.getHttpHeaders() })
      .pipe(
        tap(),
  ...
  updateInvitation(
    ...
    const url = `${this.url}/${id}`;
    return this.http
      .put<Invitation>(url, invitation, { headers: this.getHttpHeaders() })
      .pipe(
        tap(),
