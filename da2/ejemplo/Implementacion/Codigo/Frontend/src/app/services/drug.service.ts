...
export class DrugService {
  ...
  getDrugs(): Observable<Drug[]> {
    return this.http
      .get<Drug[]>(this.url, { headers: this.getHttpHeaders() })
      .pipe(tap(), catchError(this.handleError<Drug[]>('Get Drugs', [])));
  }
  ...
  getDrugsFilter(pharmacyId: string, pharmacyName: string): Observable<Drug[]> {
    ...
    return this.http
      .get<Drug[]>(this.url + filter, { headers: this.getHttpHeaders() })
      .pipe(
        tap(),
  ...
  getDrug(id: number): Observable<Drug> {
    ...
    return this.http
      .get<Drug>(url, { headers: this.getHttpHeaders() })
      .pipe(tap(), catchError(this.handleError<Drug>(`Get Drug id=${id}`)));
  }
  ...
  createDrug(drug: DrugRequest): Observable<Drug> {
    return this.http
      .post<Drug>(this.url, drug, { headers: this.getHttpHeaders() })
      .pipe(tap(), catchError(this.handleError<Drug>('Create Drug')));
  }
  ...
  deleteDrug(id: number): Observable<any> {
    ...
    return this.http
      ...
      .pipe(tap(), catchError(this.handleError<any>('Delete Drug')));
  }
  /**
