...
export class CosmeticService {
  private url = environment.apiUrl + '/api/Cosmetic';
  ...
  createCosmetic(request: Cosmetic): Observable<Cosmetic> {
    return this.http
      .post<Cosmetic>(this.url, request, { headers: this.getHttpHeaders() })
      .pipe(tap(), catchError(this.handleError<Cosmetic>('Create Cosmetic')));
  }
