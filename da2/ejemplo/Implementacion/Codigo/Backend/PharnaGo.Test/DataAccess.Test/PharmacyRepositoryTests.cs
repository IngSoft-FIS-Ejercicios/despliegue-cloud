...
namespace PharmaGo.Test.DataAccess.Test
{
    ...
    public class PharmacyRepositoryTests
    {
        ...
        [TestMethod]
        public void GetByEmployee_ReturnsCorrectPharmacy()
        {
            CreateDataBase("GetByEmployeeTestDb");
            ...
            var result = _pharmacyRepository.GetOneByExpression(p => p.Users.Any(u => u.Id == user.Id));

            Assert.IsNotNull(result);
            Assert.AreEqual("PharmacyTest", result.Name);
