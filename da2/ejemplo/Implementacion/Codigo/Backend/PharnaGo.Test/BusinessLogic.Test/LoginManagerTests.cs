...
namespace PharmaGo.Test.BusinessLogic.Test
{
    ...
    public class LoginManagerTests
    {
        ...
        public void Login_Ok()
        {
            ...
            var userId = 1;
            var pharmacyId = 1;
            var pharmacy = new Pharmacy { Id = pharmacyId, Name = "Name" };
            Session session1 = null;

            _userRespository
                .Setup(x => x.GetOneDetailByExpression(x => x.UserName.ToLower().Equals(userName.ToLower())))
                .Returns(new User() { UserName = "Juan", Password = "12345", Id = userId, Role = role, Pharmacy = pharmacy });
            ...
            Assert.AreEqual(1, response.PharmacyId);
