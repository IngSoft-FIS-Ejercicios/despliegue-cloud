    ...
    public class LoginController : ControllerBase
    {
       ...
       public LoginController(ILoginManager manager)
       {
        ...
        public IActionResult Login([FromBody] LoginModelRequest userModel)
        {
            ...
            return Ok(new LoginModelResponse() { token = authorization.Token, role = authorization.Role, userName = authorization.UserName, pharmacyId = authorization.PharmacyId });
        }
