...
import { CreateCosmeticComponent } from './pages/employee/create-cosmetic/create-cosmetic.component';
import { ManageDiscountComponent } from './pages/employee/manage-discount/manage-discount.component';
...
const routes: Routes = [
  ...
  {
    path: 'employee/purchase-status',
    component: PurchaseStatusComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Employee'] },
  },
  {
    path: 'employee/delete-drug',
    component: DeleteDrugComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Employee'] },
  },
  {
    path: 'employee/create-drug',
    component: CreateDrugComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Employee'] },
  },
  {
    path: 'employee/create-cosmetic',
    component: CreateCosmeticComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Employee'] },
  },
  {
    path: 'employee/stock-request',
  ...
  {
    path: 'employee/export-drugs',
    component: ExportDrugsComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Employee'] },
  },
  {
    path: 'employee/manage-discount',
  ...
  {
    path: 'admin/list-invitation',
    component: ListInvitationComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Administrator'] },
  },
  {
    path: 'admin/update-invitation',
    component: UpdateInvitationComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Administrator'] },
  },
  {
    path: 'admin/create-pharmacy',
  ...
  {
    path: 'owner/purchase-by-date',
    component: PurchaseByDateComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Owner'] },
  },
  {
  ...
  {
    path: 'owner/stock-request',
    component: StockRequestOwnerComponent,
    canActivate: [AuthenticationGuard],
    data: { roles: ['Owner'] },
  },
