...
export class PurchaseService {
  ...
  getPurchaseByTrackingCode(code: string): Observable<PurchaseResponse> {
    ...
    return this.http
      .get<PurchaseResponse>(url, { headers: this.getHttpHeaders() })
      .pipe(
        tap(),
        catchError(
          this.handleError<PurchaseResponse>(
  ...
  getPurchases(): Observable<PurchaseResponse> {
    ...
    return this.http
      ...
      .pipe(
        tap(),
        catchError(this.handleError<PurchaseResponse>(`Get Purchases`)),
      );
  }
  ...
  getPurchasesByDate(start: Date, end: Date): Observable<PurchaseResponse> {
    ...
    return this.http
      ...
      .pipe(
        tap(),
        catchError(this.handleError<PurchaseResponse>(`Get Purchases By Date`)),
      );
  }
  ...
  addPurchase(purchase: PurchaseRequest): Observable<PurchaseResponse> {
    return this.http
      .post<PurchaseResponse>(this.url, purchase, {
  ...
  approvePurchase(
    ...
    pharmacyId: number,
    drugCode: string,
  ): Observable<PurchaseModelResponseStatus> {
    const purchase = {
      pharmacyId: pharmacyId,
      drugCode: drugCode,
    };
    return this.http
      .put<PurchaseModelResponseStatus>(`${this.url}/approve/${id}`, purchase, {
        headers: this.getHttpHeaders(),
      })
      .pipe(
        tap(),
        catchError(
          this.handleError<PurchaseModelResponseStatus>(
            'Approve Purchase Drug',
          ),
        ),
      );
  }
  ...
  rejectPurchase(
    ...
    return this.http
      .put<PurchaseModelResponseStatus>(`${this.url}/reject/${id}`, purchase, {
        headers: this.getHttpHeaders(),
      })
      .pipe(
        tap(),
        catchError(
          this.handleError<PurchaseModelResponseStatus>('Reject Purchase Drug'),
        ),
      );
  }
