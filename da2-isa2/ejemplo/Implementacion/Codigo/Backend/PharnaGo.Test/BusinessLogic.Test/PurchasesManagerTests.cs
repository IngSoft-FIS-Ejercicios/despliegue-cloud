...
namespace PharmaGo.Test.BusinessLogic.Test
{
    ...
    public class PurchasesManagerTests
    {
        ...
        public void SetUp()
        {
            ...
            pharmacy = new Pharmacy { Id = 1, Name = "Farmacia 1", Address = "Av. Italia 12345", Users = new List<User>(), Products = new List<Product> { drug1 } };
            pharmacy2 = new Pharmacy { Id = 2, Name = "Farmacia 2", Address = "Av. Italia 22222", Users = new List<User>(), Products = new List<Product> { drug2 } };
        ...
        public void Create_Purchase_Fail_Invalid_Drug()
        {
            ...
            Pharmacy pharmacy3 = new Pharmacy { Id = 3, Name = "Farmacia 3", Address = "Av. Italia 3333", Users = new List<User>(), Products = new List<Product> { drug3 } };
        ...
        public void Create_Purchase_Fail_Invalid_Purchase_Date()
        {
            ...
            pharmacy.Products = new List<Product>();
            pharmacy.Products.Add(drug1);
            pharmacy.Products.Add(drug2);
            purchaseDetail = new List<PurchaseDetail> {
        ...
        public void Get_Purchases_All_Ok___()
        {
            ...
            pharmacy2 = new Pharmacy { Id = 100, Name = "Farmacia 100", Address = "Av. Italia 100", Users = new List<User>(), Products = new List<Product> { drug1 } };
        ...
        {
            pharmacy.Products = new List<Product> { new Drug { Deleted = true, Code = "XF32500" } };
            //Arrange
            _purchaseRespository
                .Setup(y => y.GetOneDetailByExpression(p => p.Id == 1))
                .Returns(purchase);
